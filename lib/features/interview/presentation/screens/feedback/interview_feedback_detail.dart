  ...
  Widget build(BuildContext context) {
    ...
    return Consumer<InterviewProvider>(
      builder: (context, provider, child) {
        ...
        // Try to get question text and transcript
        ...
        if (_currentIndex < provider.questions.length) {
            userTranscript = provider.questions[_currentIndex].userAnswerTranscript ?? '';
        }
            ...
            child: SingleChildScrollView(
              child: Column(
                ...
                children: [
                  ...
                  Container(
                    ...
                    child: Column(
                      ...
                      children: [
                         Row(
                          children: [
                            Icon(Iconsax.info_circle, color: Theme.of(context).textTheme.titleLarge?.color),
                            const SizedBox(width: 8),
                            Text(
                              l10n.feedback,
                  ...
                  Container(
                    ...
                    child: Column(
                      ...
                      children: [
                          ...
                          children: [
                            ...
                            Text(
                              ...
                              style: Theme.of(context).textTheme.headlineSmall?.copyWith(
                                color: _getScoreColor(feedback.starAnalysis.score * 10),
                        ...
                        _buildPresenceRow(context, 'Situation', feedback.starAnalysis.situation.present),
                        const SizedBox(height: 8),
                        _buildPresenceRow(context, 'Task', feedback.starAnalysis.task.present),
                         const SizedBox(height: 8),
                        _buildPresenceRow(context, 'Action', feedback.starAnalysis.action.present),
                         const SizedBox(height: 8),
                        _buildPresenceRow(context, 'Result', feedback.starAnalysis.result.present),
                      ],
                    ),
                  ),
                          ...
                          children: [
                            Row(
                              children: [
                                ...
                                const SizedBox(width: 8),
                                Text(
                                  l10n.fluencyAnalysis, // Ensure key exists or use 'Fluency'
                                  style: Theme.of(context).textTheme.titleLarge?.copyWith(
                                    fontWeight: FontWeight.w600,
                                  ),
                                ),
                            ...
                            Text(
                              ...
                              style: Theme.of(context).textTheme.headlineSmall?.copyWith(
                                color: _getScoreColor(feedback.fluencyAnalysis.score * 10),
                                fontWeight: FontWeight.bold,
                              ),
                            ),
                          ],
                  ...
                  // User Answer & Improved Answer Comparison
                  Container(
                    margin: const EdgeInsets.symmetric(horizontal: 16),
                    padding: const EdgeInsets.all(20),
                    decoration: BoxDecoration(
                      ...
                      children: [
                        ...
                        Container(
                          ...
                          child: Column(
                            ...
                            children: [
                               Text(
                                l10n.originalSpeechLabel, // 'Original Answer'
                                style: TextStyle(
                                  fontSize: 12,
                                  fontWeight: FontWeight.w600,
                                  color: Theme.of(context).brightness == Brightness.light 
                              ...
                              const SizedBox(height: 8),
                              Text(
                                userTranscript.isNotEmpty ? userTranscript : 'No answer recorded.',
                                style: TextStyle(
                                  fontSize: 16,
                                  color: Theme.of(context).brightness == Brightness.light 
                            ...
                            children: [
                              Row(
                                children: [
                                  ...
                                  const SizedBox(width: 8),
                                  Text(
                                    l10n.improvedSpeechLabel, // 'AI Improved Version'
                                    style: TextStyle(
                                      fontSize: 12,
                                      fontWeight: FontWeight.w600,
                                      color: Theme.of(context).brightness == Brightness.light 
            ...
            child: SafeArea(
              child: Row(
                children: [
                  ...
                  // Maybe navigation to next/prev just updates the state instead of pushing new routes? 
                  // Yes, setState handles it.
                  
                  // 'Practice Again' button could just pop or go to prep.
                  // For now let's remove it to simplify or just have next/prev.
          ...
          children: [
              ...
              Row(
                  children: [
                      ...
                      const SizedBox(width: 8),
                      Text(
                          isPresent ? 'Present' : 'Missing', // Needs localization ideally
                          style: TextStyle(
                              color: isPresent ? AppColors.secondary : AppColors.error,
                              fontWeight: FontWeight.bold,
                          ),
