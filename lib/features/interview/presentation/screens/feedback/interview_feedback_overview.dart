...
class InterviewFeedbackOverviewScreen extends StatelessWidget {
                    ...
                    children: [
                      ...
                      CustomPaint(
                        ...
                        painter: _CircularGaugePainter(
                          ...
                          progressColor:
                              _getScoreColor(context, report.overallScore),
                        ),
                        child: SizedBox(
                          width: 180,
                          height: 180,
                    ...
                    children: [
                      ElevatedButton.icon(
                        onPressed: () => context.router
                            .push(const InterviewFeedbackQuestionsRoute()),
  ...
  double _calculateAverageStarScore(providerReport) {
    ...
    final total = providerReport.questionFeedbacks
        .fold(0, (sum, q) => sum + q.starAnalysis.score);
  ...
  double _calculateAverageFluencyScore(providerReport) {
    if (providerReport.questionFeedbacks.isEmpty) return 0.0;
    final total = providerReport.questionFeedbacks
        .fold(0, (sum, q) => sum + q.fluencyAnalysis.score);
    return total / providerReport.questionFeedbacks.length;
  }
  ...
  String _getScoreLabel(AppLocalizations l10n, int score) {
    if (score >= 80) return l10n.passGood;
    if (score >= 60) return l10n.passFair;
    return l10n.fail;
  }
